...
<?= $this->section('content') ?>
    ...
    <div class="card">
        <div class="card-body">
            <?= form_open_multipart(route_to('updateEmployee'), [], ['id' => $employee->id]) ?>
            <?= csrf_field(); ?>
            <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                   ...
                                   name="name" placeholder="Nama" aria-label="name" aria-describedby="name"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="datepicker" data-toggle="datetimepicker"
                                   ...
                                   value="<?= format_day($employee->date_of_birth) ?>" placeholder="Tanggal Lahir">
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                   ...
                                   name="place_of_birth" id="place_of_birth" value="<?= $employee->place_of_birth ?>" placeholder="Tempat Lahir">
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                   ...
                                   name="phone" id="phone" placeholder="Telepon" value="<?= $employee->phone ?>">
                        </div>
                ...
                <div class="col col-sm-4">
                    <div class="mb-3">
                        ...
                        <div class="text-center">
                            <img id="previewImage" src="<?= base_url('/uploads/images/employee'); ?>/<?= $employee->image ?>"
