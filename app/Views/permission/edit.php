<div class="modal fade" id="editModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open(route_to('updatePermission'), ['class' => 'formUpdate'], ['id' => $permission->id]); ?>
            <?= csrf_field(); ?>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" name="description" id="description" class="form-control"
                               value="<?= $permission->description ?>" autocomplete="off">
                    </div>
                    <small class="text-danger errorName"></small>
                </div>
            </div>
    ...
    $(document).ready(function () {
        $('.formUpdate').submit(function (e) {
            ...
            setAjax($(this).attr("action"), $(this).attr("method"), $(this).serialize(), function (response) {
                ...
                simpleSweetAlert('success', 'Permission berhasil diupdate').then(() => {
