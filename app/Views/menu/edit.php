...
<?= $this->section('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <?= form_open_multipart(route_to('updateMenu'), [], ['id' => $menu->id, 'oldImage' => $menu->image]); ?>
            <?= csrf_field(); ?>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" id="name"
                                   ...
                                   value="<?= $menu->name ?>" placeholder="Nama">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" id="category_id"
                            ...
                            <?php foreach ($category as $row) : ?>
                                <option value="<?= $row->id; ?>" <?= $menu->category_id === $row->id ? 'selected' : '' ?>><?= $row->name; ?></option>
                            <?php endforeach; ?>
                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" min="0" max="100" name="discount" id="discount"
                                           class="form-control" value="<?= $menu->discount ?>" placeholder="Diskon">
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="result" class="form-control" disabled placeholder="Hasil"
                                           value="<?= rupiah($menu->sell - ($menu->sell * $menu->discount) / 100) ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="text-center">
                        <img id="previewImage" src="<?= base_url('/uploads/images/menu'); ?>/<?= $menu->image ?>"
            ...
            <div class="form-group text-center">
                ...
                <button class="btn btn-warning"><i class="fas fa-retweet"> <span class='d-none d-lg-inline-flex'> Update</span></i></button>
            </div>
            <?= form_close(); ?>
        </div>
    </div>
