<div class="modal fade" id="editModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open(route_to('updateDistribution'), ['class' => 'formUpdate'], ['id' => $distribution->id]); ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="cost" class="col-form-label col-md-3">Harga</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-coins"></i></span>
                        </div>
                        <input type="text" name="cost" id="cost" class="form-control"
                               value="<?= number_format($distribution->cost, 0, ',', '.') ?>">
                    </div>
    ...
    $(document).ready(function () {
        ...
        $('.formUpdate').submit(function (e) {
            ...
            setAjax($(this).attr("action"), $(this).attr("method"), $(this).serialize(), function (response) {
                ...
                simpleSweetAlert('success', 'Distribusi berhasil diupdate').then(() => {
